...
extension_name := youtubetimebookmarks

# The UUID of the extension.
extension_uuid := youtubetimebookmarks@programmingregrets.com

# The name of the profile dir where the extension can be installed.
profile_dir := ssxd6kp0.dev
...
install: $(build_dir) $(xpi_built)
	@echo "Installing in profile folder: $(profile_location).xpi"
	@cp -f $(xpi_file) $(profile_location).xpi
